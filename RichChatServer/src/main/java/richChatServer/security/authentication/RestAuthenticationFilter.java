...
/**
 * Filtre d'interception d'une authentification HTTP Rest.
 *
 * S'appuie sur le service de validation de beans pour valider les données de la requête d'authentification
 *
 * @author Remi Venant
 */
public class RestAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        try {
            ...
            UsernamePasswordAuthenticationToken token = new UsernamePasswordAuthenticationToken(lc.email, lc.password);
    ...
    public static class LoginCredentials {
        ...
        @NotBlank
        @Pattern(regexp = "[\\w%:;<>\\.\\*\\#\\$\\?\\+\\-]{4,100}", flags = Pattern.Flag.CASE_INSENSITIVE)
